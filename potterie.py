...
class PotteryCamera:
    def __init__(self):
        ...
        self.rotation_speed = 1.0  # Vitesse de rotation en degrés par frame
...
class PotteryDrawing:
    ...
    def adjust_rotation_speed(self, increment):
        ...
        # Limiter la vitesse entre 0.1 et 5.0
        self.camera.rotation_speed = max(0.1, min(5.0, self.camera.rotation_speed))
...
def main():
    try:
        ...
        drawing.show_message("ESPACE: On/Off rotation | +/-: Vitesse | C: Effacer | O: Exporter OBJ", 300)
        ...
        while running:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_ESCAPE:
                        ...
                        drawing.adjust_rotation_speed(0.2)
            ...
            # Afficher les FPS dans le titre (optionnel)
            # pygame.display.set_caption(f"Tour de Potier 3D - FPS: {int(clock.get_fps())}")
