...
class Camera:
    def __init__(self):
        ...
        self.rotation_speed = 8.0  # Sensibilité encore plus élevée
...
class Drawing3D:
    def __init__(self, camera):
        ...
        self.smoothing_factor = 0.5  # Facteur de lissage (0-1)
        self.prev_dx = 0
        self.prev_dy = 0
    ...
    def navigate(self, current_point):
        """Gère la navigation dans l'environnement 3D avec un mouvement lissé et continu"""
        ...
        # Normaliser la rotation X pour éviter de "dépasser" les pôles
        self.camera.rotation_x = max(-90, min(90, self.camera.rotation_x))
        
        # La rotation Y peut faire des tours complets (modulo 360)
        self.camera.rotation_y = self.camera.rotation_y % 360
...
def main():
    try:
        ...
        while running:
            ...
            # Afficher les informations de rotation pour le débogage
            # print(f"Rotation: X={camera.rotation_x:.1f}, Y={camera.rotation_y:.1f}", end="\r")
