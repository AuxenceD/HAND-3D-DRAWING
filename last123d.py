...
class AirCanvasCamera:
    def __init__(self):
        ...
        self.rotation_sensitivity = 100.0  # Considérablement augmenté pour des rotations ultra-rapides
...
class Drawing3D:
    def __init__(self, camera):
        ...
        self.last_hand_position = None  # Dernière position de la main pour la navigation
        self.start_pinch_position = None  # Position de la main au début du pincement
    ...
    def navigate(self, hand_position):
        """Effectue la rotation de la caméra de manière cumulative avec sensibilité très élevée"""
        ...
        # Appliquer la rotation de façon cumulative avec sensibilité très élevée
    ...
    try:
        ...
        while running:
            ...
            if pygame.K_a in keys_pressed and keys_pressed[pygame.K_a]:
                camera.rotation_y -= 5.0  # Rotation clavier plus rapide
            ...
            if results.multi_hand_landmarks:
                ...
                if left_hand:
                    ...
                    # Calculer le point milieu entre pouce et index pour la navigation
                    class HandPoint:
