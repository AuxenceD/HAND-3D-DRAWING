...
class Drawing3D:
    ...
    def navigate(self, current_point):
        ...
        if self.last_navigation_point is not None:
            ...
            dx = (current_point[0] - self.last_navigation_point[0]) * 2  # Augmentation de la vitesse horizontale
            dy = (current_point[1] - self.last_navigation_point[1]) * 2  # Augmentation de la vitesse verticale
